...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def camera_capture(self):
        global filename, pic_dir, name_dir
        self.camera = gp.Camera()
        ...
        try:
            ...
            if os.path.exists(new_dir):
                self.textEdit_message.setText("Picture Captured and Stored in‣ \n" + pic_dir) 
                QMessageBox.information(None,"Capture successful","Picture Captured and Stored in‣ \n" + pic_dir) 
    ...
    def camerasummary(self):
        ...
        try:
            ...
            self.textEdit_message.setText("Check the following:\n➊Camera is ON.\n➋Battery is present and charged.\n➌USB is connected.")
